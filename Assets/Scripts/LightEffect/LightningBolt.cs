...
namespace MonsterAdventure.LightEffect
{
    class LightningBolt : MonoBehaviour
    {
        ...
        public Vector2 Start { get { return ActiveLineObj[0].GetComponent<Line>().Start; } }

        //The position where our bolt ended
        public Vector2 End { get { return ActiveLineObj[ActiveLineObj.Count - 1].GetComponent<Line>().End; } }
