...
namespace MonsterAdventure
{
    ...
    public class Noise
    {
        public NoiseMethod[] valueMethods;
        public NoiseMethod[] perlinMethods;
        public NoiseMethod[] simplexValueMethods;
        public NoiseMethod[] simplexMethods;

        public NoiseMethod[][] methods;
        ...
        public Noise()
        {
            valueMethods = new NoiseMethod[3];
            valueMethods[0] = Value1D;
            valueMethods[1] = Value2D;
            valueMethods[2] = Value3D;

            perlinMethods = new NoiseMethod[3];
            perlinMethods[0] = Perlin1D;
            perlinMethods[1] = Perlin2D;
            perlinMethods[2] = Perlin3D;

            simplexValueMethods = new NoiseMethod[3];
            simplexValueMethods[0] = SimplexValue1D;
            simplexValueMethods[1] = SimplexValue2D;
            simplexValueMethods[2] = SimplexValue3D;

            simplexMethods = new NoiseMethod[3];
            simplexMethods[0] = Simplex1D;
            simplexMethods[1] = Simplex2D;
            simplexMethods[2] = Simplex3D;

            methods = new NoiseMethod[4][];
            methods[0] = valueMethods;
            methods[1] = perlinMethods;
            methods[2] = simplexValueMethods;
        ...
        public NoiseSample Value1D(Vector3 point, float frequency)
        {
            point *= frequency;
        ...
        public NoiseSample Value2D(Vector3 point, float frequency)
        {
            point *= frequency;
        ...
        public NoiseSample Value3D(Vector3 point, float frequency)
        {
            point *= frequency;
            int ix0 = Mathf.FloorToInt(point.x);
            int iy0 = Mathf.FloorToInt(point.y);
        ...
        public NoiseSample Perlin1D(Vector3 point, float frequency)
        {
            point *= frequency;
            int i0 = Mathf.FloorToInt(point.x);
            float t0 = point.x - i0;
        ...
        public NoiseSample Perlin2D(Vector3 point, float frequency)
        {
            point *= frequency;
            int ix0 = Mathf.FloorToInt(point.x);
            int iy0 = Mathf.FloorToInt(point.y);
        ...
        public NoiseSample Perlin3D(Vector3 point, float frequency)
        {
            point *= frequency;
            int ix0 = Mathf.FloorToInt(point.x);
            int iy0 = Mathf.FloorToInt(point.y);
        ...
        public NoiseSample SimplexValue1D(Vector3 point, float frequency)
        {
            point *= frequency;
        ...
        public NoiseSample SimplexValue2D(Vector3 point, float frequency)
        {
            point *= frequency;
        ...
        public NoiseSample SimplexValue3D(Vector3 point, float frequency)
        {
            point *= frequency;
        ...
        public NoiseSample Simplex1D(Vector3 point, float frequency)
        {
            point *= frequency;
            int ix = Mathf.FloorToInt(point.x);
        ...
        public NoiseSample Simplex2D(Vector3 point, float frequency)
        {
            point *= frequency;
            float skew = (point.x + point.y) * trianglesToSquares;
            float sx = point.x + skew;
        ...
        public NoiseSample Simplex3D(Vector3 point, float frequency)
        {
            point *= frequency;
            float skew = (point.x + point.y + point.z) * (1f / 3f);
            float sx = point.x + skew;
